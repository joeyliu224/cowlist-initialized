...
export default function ListEntry({cow,handleClick,handleDelete,handleUpdate,handleNameChange,needUpdate,handleUpdateSubmit,updateName}) {
    return (
        <div>
            ...
            {needUpdate === cow._id? 
                <form id={cow._id} onSubmit={handleUpdateSubmit}>
                    <input type='text' value={updateName} onChange={handleNameChange}/>
